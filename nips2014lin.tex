...
of $0.1$ on them. We initialize $\lvar$ at $10^{-14}$ in the EGP and UGP, and
place a lower bound at $10^{-14}$ (the optimized values are near or at this
values). The hyperparameters for the SVM are learned using grid search with
