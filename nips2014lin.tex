...
(from the GPML matlab toolbox), a support vector machine (with probabilistic
outputs), and logistic regression (both from the scikits-learn python library).
...
optimised values are near these values).
