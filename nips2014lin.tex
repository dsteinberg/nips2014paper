...
derived our updates from first principles using a variational approximation. 
...
& \cite{Opper2009} & 12.84628 & 20.13524 & 0.38918 & 0.40181 & 0.42748 &
0.49311 \\
        \midrule
        $\exp\!\brac{\lstate}$ 
...
classifier. We also report the error rate as the percentage of incorrectly
...
processes in this experiment. We initialize these hyperparameters at $1.0$, and
