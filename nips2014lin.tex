...
expectations. We also test against normal GP regression for a linear forward
...
UGP in these experiments, even though the EGP has access to the derivatives of
...
found that \cite{Opper2009} would not run on the non-differentiable forward
model in \autoref{fig:learnex}, but the authors do state that their algorithm
does require smooth likelihood models.
